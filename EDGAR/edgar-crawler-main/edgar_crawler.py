...
class Crawler:
	...
	def __init__(self):
		...
		with open('config.json') as fin:
			self.config = json.load(fin)['edgar_crawler']

		# Define the directories and filepaths
		self.raw_filings_folder = os.path.join(DATASET_DIR, self.config['raw_filings_folder'])
		self.indices_folder = os.path.join(DATASET_DIR, self.config['indices_folder'])
		self.filings_metadata_filepath = os.path.join(DATASET_DIR, self.config['filings_metadata_file'])
