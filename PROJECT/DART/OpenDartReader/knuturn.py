...
f = open('./data/kospi_top_30.txt', 'r', encoding = 'utf-8')
lines = f.readlines()
...
with open('./data/20230101_20240329_report_list.json', 'r', encoding = 'utf-8')  as f :
...
with open('./data/20230101_20240329_report_url.json', 'r', encoding = 'utf-8') as f :
    report_url = json.load(f)

report_data = a.getReportData2(report_url)

with open("./data/20230101_20240329_report_data.json", 'r', encoding='utf-8') as f :
    report_data = json.load(f)

# 한 파일에 모든 기업들 사업보고서 담기
with open('./data/20230101_20240329_report_data.json', 'w', encoding = 'utf-8') as f :
    json.dump(report_data, f, ensure_ascii = False, indent = '\t')

# 기업마다 사업보고서들 담기
for corp in report_data.keys() :
    output_file_name = f"./data/report_per_corp/{corp}_report"
    d = {}
    d[corp] = report_data[corp]
